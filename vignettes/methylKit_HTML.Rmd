---
title: "methylKit: User Guide V.2"
...
vignette: >
  %\VignetteIndexEntry{methylKit: User Guide V.2}
...
Every function in this package will work with methylDB objects the same way as it does with normal methylKit objects. 
...
`read.bismark()` command on the example files.
...
with important code contributions from Matthias Kormaksson (mk375@cornell.edu) 
...
Recent contributions to the package came from: 

*  Adrian Bierling (add email)
*  Alexander Gosdschan (alexgos@zedat.fu-berlin.de)
