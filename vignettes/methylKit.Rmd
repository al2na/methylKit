...
You can easily find the underlying flatfile database using the `getDBPath()`
function which prints the absolute location. methylRawDBPlease note that
...
The package methylKit is designed for analysing methylation data from bisulfite
sequencing (such as WGBS or RRBS) and as such dos not provide any preprocessing
