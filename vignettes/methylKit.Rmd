...
Starting from version 1.11.1, when generating tabix files we are storing all 
...
exported with `makeMethylDB()` function whenever using methylKit versions > 1.11.1. 
