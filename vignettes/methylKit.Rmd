...
have the same order. In the following example, first two files are have the 
...
to a folder given by `save.folder` option. The saved files can be read-in using the `read` function when needed. 
