...
\end{flushleft}
\begin{verbatim}
## GRanges with 963 ranges and 13 elementMetadata values:
##         seqnames               ranges strand   |             id coverage1    numCs1
##            <Rle>            <IRanges>  <Rle>   |       <factor> <integer> <numeric>
##     [1]    chr21 [10011833, 10011833]      +   | chr21.10011833       174       173
##     [2]    chr21 [10011841, 10011841]      +   | chr21.10011841       173       164
##     [3]    chr21 [10011855, 10011855]      +   | chr21.10011855       175       175
##     [4]    chr21 [10011858, 10011858]      +   | chr21.10011858       175       131
##     [5]    chr21 [10011861, 10011861]      +   | chr21.10011861       174       147
##     [6]    chr21 [10011872, 10011872]      +   | chr21.10011872       167       160
##     [7]    chr21 [10011876, 10011876]      +   | chr21.10011876       160       148
##     [8]    chr21 [10011878, 10011878]      +   | chr21.10011878       150       134
##     [9]    chr21 [10011925, 10011925]      -   | chr21.10011925       120        65
##     ...      ...                  ...    ... ...            ...       ...       ...
##   [955]    chr21   [9944505, 9944505]      +   |  chr21.9944505        37         2
##   [956]    chr21   [9944663, 9944663]      -   |  chr21.9944663        61        19
##   [957]    chr21   [9959407, 9959407]      +   |  chr21.9959407        44        17
##   [958]    chr21   [9959541, 9959541]      -   |  chr21.9959541        26        12
##   [959]    chr21   [9959569, 9959569]      -   |  chr21.9959569        25        17
##   [960]    chr21   [9959577, 9959577]      -   |  chr21.9959577        25        25
##   [961]    chr21   [9959644, 9959644]      -   |  chr21.9959644        21         0
##   [962]    chr21   [9959650, 9959650]      -   |  chr21.9959650        21         6
...
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{select}\hlkeyword{(}\hlsymbol{meth}\hlkeyword{,}{\ }\hlnumber{1}\hlkeyword{:}\hlnumber{10}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }select{\ }first{\ }10{\ }rows}\mbox{}
\normalfont
\end{flushleft}
\begin{verbatim}
##                id   chr    start      end strand coverage1 numCs1 numTs1 coverage2
...
## 5  chr21.10011861 chr21 10011861 10011861      +       174    147     27        20
## 6  chr21.10011872 chr21 10011872 10011872      +       167    160      7        20
## 7  chr21.10011876 chr21 10011876 10011876      +       160    148     12        21
## 8  chr21.10011878 chr21 10011878 10011878      +       150    134     16        20
## 9  chr21.10011925 chr21 10011925 10011925      -       120     65     55        37
## 10 chr21.10011938 chr21 10011938 10011938      -       134    127      7        36
##    numCs2 numTs2 coverage3 numCs3 numTs3 coverage4 numCs4 numTs4
## 1      18      0        40     34      6        14     14      0
## 2      19      1        40     18     22        14      8      6
## 3      21      0        39     29     10        14     12      2
...
## 5      15      5        39     13     26        13      9      4
## 6      19      1        39     34      5        14      8      6
## 7      18      3        38     24     14        11      9      2
## 8      19      1        37     20     17        12     12      0
## 9      21     16        68     21     47        20      6     14
## 10     34      2        74     64     10        20     17      3
\end{verbatim}
\begin{flushleft}
\ttfamily\noindent
\hlfunctioncall{select}\hlkeyword{(}\hlsymbol{myDiff}\hlkeyword{,}{\ }\hlnumber{20}\hlkeyword{:}\hlnumber{30}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }select{\ }rows{\ }10}\mbox{}
\normalfont
\end{flushleft}
\begin{verbatim}
