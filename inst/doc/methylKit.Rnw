...
Answers to frequently asked questions and various how-tos can be found at \url{http://zvfak.blogspot.com/search/label/methylKit}. In addition, \url{http://code.google.com/p/methylkit/} has online documentation and links to tutorials and other related material.



\section{Acknowledgements}
This package is developed at Weill Cornell Medical College by Altuna Akalin with important code contributions from Sheng Li and Matthias Kormaksson. We wish to thank especially Maria E. Figueroa, Francine Garret-Bakelman, Chrisopher Mason and Ari Melnick for their contribution of ideas, data and support. Their support and discussions lead to development of methylKit.
